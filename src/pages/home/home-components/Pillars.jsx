    ...
    return (
        <div className="pillar">
            ...
            <div class="flex flex-wrap justify-center gap-14 mt-10">
                {/* <!-- Card 1 --> */}
                <div className="group relative cursor-pointer overflow-hidden bg-amber-50 rounded-2xl w-80 px-6 pt-12 pb-10 shadow-2xl ring-1 ring-gray-900/5 transition-all duration-500 transform hover:scale-105 hover:shadow-3xl hover:bg-orange-500"> {/* Add hover:bg-orange-500 */}
                ...
                {/* <!-- Card 2 --> */}
                <div class="group relative cursor-pointer overflow-hidden bg-amber-50 rounded-2xl w-80 px-6 pt-12 pb-10 shadow-2xl ring-1 ring-gray-900/5 transition-all duration-500 transform hover:scale-105 hover:shadow-3xl hover:bg-orange-500">
