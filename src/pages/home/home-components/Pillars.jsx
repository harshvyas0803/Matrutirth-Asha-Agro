    ...
    <div className="pillar">
      ...
      <div className="flex flex-wrap justify-center gap-14 mt-10">
        ...
        <div className="group relative cursor-pointer overflow-hidden bg-amber-50 rounded-2xl w-80 px-6 pt-12 pb-10 shadow-2xl ring-1 ring-gray-900/5 animate-strong-breathing transition-all duration-500 hover:shadow-3xl hover:bg-orange-500">
          <span className="absolute top-0 left-0 z-0 h-32 w-32 rounded-full opacity-75 transition-all duration-500 transform group-hover:scale-[20]"
                style={{ background: "linear-gradient(312deg, rgba(146,64,14,1) 0%, rgba(245,158,11,1) 100%)" }}>
          </span>
          
          <div className="relative z-10 mx-auto max-w-md">
            <span className="grid h-32 w-32 place-items-center rounded-full transition-all duration-500 transform"
                  style={{ background: "linear-gradient(312deg, rgba(146,64,14,1) 0%, rgba(245,158,11,1) 100%)" }}>
